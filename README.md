...
| 测试用例 | GoPy | CPython | 比率 | 状态 |
|---------|------|---------|------|------|
| 简单计算 | 501.3 ms | 70.4 ms | 7.12x | ✅ |
| 函数调用 | 402.0 ms | 91.5 ms | 4.39x | ✅ |
| 循环操作 | 474.4 ms | 92.6 ms | 5.12x | ✅ |
| **平均** | **459.3 ms** | **84.8 ms** | **5.41x** | ✅ |

> **说明**：GoPy 执行时间包含编译 + 解释两部分。查看详细基准测试结果请访问 [基准测试文档](./TEST_BENCHMARKS.md)。
