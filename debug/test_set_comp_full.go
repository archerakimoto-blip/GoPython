...
func main() {
	...
	for i < len(instructions) {
		...
		fmt.Printf("[%d]", i)
		switch op {
		case compiler.OpConstant, compiler.OpJump, compiler.OpJumpNotTruthy, compiler.OpGetGlobal, compiler.OpSetGlobal, compiler.OpArray, compiler.OpHash, compiler.OpSet:
