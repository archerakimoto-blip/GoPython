...
func opcodeName(op compiler.Opcode) string {
	switch op {
	case compiler.OpConstant: return "CONSTANT"
	case compiler.OpClosure: return "CLOSURE"
	case compiler.OpPop: return "POP"
	case compiler.OpDupTop: return "DUP_TOP"
	case compiler.OpAdd: return "ADD"
	case compiler.OpSub: return "SUB"
	case compiler.OpMul: return "MUL"
	case compiler.OpDiv: return "DIV"
	case compiler.OpTrue: return "TRUE"
	case compiler.OpFalse: return "FALSE"
	case compiler.OpEqual: return "EQUAL"
	case compiler.OpNotEqual: return "NOT_EQUAL"
	case compiler.OpGreaterThan: return "GREATER"
	case compiler.OpLessThan: return "LESS"
	case compiler.OpMinus: return "MINUS"
	case compiler.OpBang: return "BANG"
	case compiler.OpJump: return "JUMP"
	case compiler.OpJumpNotTruthy: return "JUMP_NOT_TRUTHY"
	case compiler.OpNull: return "NULL"
	case compiler.OpSetGlobal: return "SET_GLOBAL"
	case compiler.OpGetGlobal: return "GET_GLOBAL"
	case compiler.OpArray: return "ARRAY"
	case compiler.OpHash: return "HASH"
	case compiler.OpSet: return "SET"
	case compiler.OpCall: return "CALL"
	case compiler.OpReturn: return "RETURN"
	case compiler.OpGetLocal: return "GET_LOCAL"
	case compiler.OpSetLocal: return "SET_LOCAL"
	case compiler.OpGetAttr: return "GET_ATTR"
	case compiler.OpSetAttr: return "SET_ATTR"
	case compiler.OpIndex: return "INDEX"
	case compiler.OpSlice: return "SLICE"
	case compiler.OpPrint: return "PRINT"
	case compiler.OpGetBuiltin: return "GET_BUILTIN"
	case compiler.OpMakeFunction: return "MAKE_FUNC"
	case compiler.OpTry: return "TRY"
	case compiler.OpExcept: return "EXCEPT"
	case compiler.OpRaise: return "RAISE"
	case compiler.OpGetIter: return "GET_ITER"
	case compiler.OpForIter: return "FOR_ITER"
	case compiler.OpNot: return "NOT"
	case compiler.OpAnd: return "AND"
	case compiler.OpOr: return "OR"
	case compiler.OpYield: return "YIELD"
	case compiler.OpSend: return "SEND"
	case compiler.OpListAppend: return "LIST_APPEND"
	case compiler.OpDictSetItem: return "DICT_SET"
	case compiler.OpGetItem: return "GET_ITEM"
	case compiler.OpSetItem: return "SET_ITEM"
	case compiler.OpDeleteItem: return "DEL_ITEM"
	case compiler.OpCompare: return "COMPARE"
